/**
 * This class is provided by Sun in their online Swing tutorial see:  
 * http://java.sun.com/docs/books/tutorial/uiswing/components/table.html
 * http://java.sun.com/docs/books/tutorial/uiswing/components/example-1dot4/TableSorter.java
 * Copyright 1995-2005 Sun Microsystems, Inc. All rights reserved.
 *  
 * <b>Modifications made for Hapsby</b>
 * <ul>
 * <li>Added method - public abstract void notifySortingStatusChanged() - needed to support resizing rows after sorting.</li>
 * <li>Fixed a few warnings, suppressed others.</li>
 * <li>Organized imports.</li>
 * </ul>
 * 
 * <b>Original class comments</b>
 * 
...
public abstract class TableSorter extends AbstractTableModel {
	private static final long serialVersionUID=3189729826443038616L;
    ...
    private class Row implements Comparable {
        ...
        public int compareTo(Object o) {
            ...
            for (Iterator<Directive> it = TableSorter.this.sortingColumns.iterator(); it.hasNext();) {
    ...
    private class TableModelHandler implements TableModelListener {
        @SuppressWarnings("synthetic-access") public void tableChanged(TableModelEvent e) {
    ...
    private class MouseHandler extends MouseAdapter {
        @SuppressWarnings("synthetic-access") public void mouseClicked(MouseEvent e) {
    ...
    private static class Arrow implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            int y1 = y + 5*this.size/6 + (this.descending ? -dy : 0);
    ...
    private class SortableHeaderRenderer implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, 
                                                       ...
                                                       int row, 
                                                       int column) {
            Component c = this.tableCellRenderer.getTableCellRendererComponent(table, 
     ...
     */
    public abstract void notifySortingStatusChanged();
